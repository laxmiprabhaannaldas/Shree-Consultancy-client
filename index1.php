				...
				<div class="container">
					<div class="row fullscreen align-items-center justify-content-between">
						<div class="col-lg-6 col-md-6 banner-left">
							<h6>This is </h6><br>
							<b><font size=80 color="black">Shree Consultancy</font></b><br><br>
							<p>
								-------------------------------------(information about shreee consultancy  in short)------------------------------------------------
							</p>
							<!--<a href="#" class="primary-btn text-uppercase">discover now</a>-->
						</div>
						<div class="col-lg-6 col-md-6 banner-right d-flex align-right">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
                        ...
                        <div class="col-lg-5 col-md-6 col-sm-6">
                            <div class="single-footer-widget">
                                <h4>Newsletter</h4>
                                <p>Stay updated with our latest services</p>
